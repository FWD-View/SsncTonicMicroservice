...
namespace Tonic.Common.DB2Helper
{
    ...
    public sealed class DB2ToolCommand
    {
        /// <summary>
        ...
        public DB2ToolCommand(OracleTool tool)
        {
            Id = Guid.NewGuid();
            ExitCode = null;
            Tool = tool;
    ...
    public static partial class DB2ToolCommandExtensions
    {
        ...
        public static async Task RunWithRetriesAsync(this DB2ToolCommand command, int totalTryCount, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private static async Task RunAsync(this DB2ToolCommand command, CancellationToken cancellationToken)
        {
            await Task.Yield();
        ...
        /// </summary>
        private static void ClearRuntimeState(this DB2ToolCommand toolCommand)
        {
            try
            {
